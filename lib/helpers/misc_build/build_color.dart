...
class BuildColor {
  ...
  ///```
  Color get bottomAppBar => Theme.of(_context).primaryColor;
  ...
  ///```
  Color get background => Theme.of(_context).primaryColor;
  ...
  ///```
  Color get error => Theme.of(_context).primaryColor;

  ///```dart
  ///return Theme.of(context).toggleableActiveColor
  ///```
  Color get toggleableActive => Theme.of(_context).primaryColor;
}
